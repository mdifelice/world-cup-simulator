...
const en: Record<string, string> = {
  ...
  "lineup.suspendedNote": "Suspended for this match: {names}",
  "lineup.redCard": "red card",
  "lineup.injury": "injury",
  "lineup.oneMatch": "1 match",
  "lineup.matches": "{n} matches",
...
const es: Record<string, string> = {
  ...
  "lineup.suspendedNote": "Sancionado para este partido: {names}",
  "lineup.redCard": "tarjeta roja",
  "lineup.injury": "lesión",
  "lineup.oneMatch": "1 partido",
  "lineup.matches": "{n} partidos",
